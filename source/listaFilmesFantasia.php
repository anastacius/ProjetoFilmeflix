...
$genero_id = 14; // ID para o gênero Fantasia
$idioma = 'pt-BR';
...
<div class="container mt-5">
    ...
    <form action="" method="GET" class="mb-4">
        <div class="row g-2">
            <div class="col-md-8">
                <input type="text" name="busca" class="form-control" placeholder="Buscar em Fantasia..." value="<?php echo htmlspecialchars($termo_busca); ?>">
            </div>
            <div class="col-md-3">
    ...
    <div class="row">
            ...
            <?php foreach ($filmes as $filme): ?>
                <?php if (!empty($filme->poster_path)): ?>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-4">
                        <div class="movie-item-fantasia text-center"> 
        ...
        <?php else: ?>
            <div class="alert alert-warning" role="alert">
                Nenhum filme encontrado com este critério.
            </div>
        <?php endif; ?>
    </div>
